...
# 傳繪 A 函式內容
def a(x, y, scale=1, color="#FF2D2D"):
    outstring = '''
...
@bg5_40323204_2.route('/acbd')
def draw_acbd():
    #return head_str + chain_str + a(0, 0) + b(0+65, 0) + c(0+65*2, 0) + d(0+65*3, 0) + tail_str
    return head_str + chain_str + a(0, 110) + c(0, 110-110) + b(0, 110-110*2) + d(0, 110-110*3) +c(0+65,110)+b(0+65*2,110)+d(0+65*3,110)+ tail_str
